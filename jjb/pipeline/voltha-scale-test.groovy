    ...
    stage('Configuration') {
      steps {
        sh '''
          ...
          voltctl log level set debug adapter-open-olt#github.com/opencord/voltha-lib-go/v4/pkg/kafka
          voltctl log level set debug adapter-open-olt#github.com/opencord/voltha-openolt-adapter/internal/pkg/core
