      ...
      steps {
        sh '''
          ...
          for i in $(seq 0 $LIMIT); do
            ...
            kubectl exec -it $INSTANCE -- bash /root/onos/${karafHome}/bin/client log:set WARN org.opencord.sadis
            kubectl exec -it $INSTANCE -- bash /root/onos/${karafHome}/bin/client log:set TRACE org.opencord.aaa
          done
