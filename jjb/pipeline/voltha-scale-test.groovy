      ...
      steps {
        sh '''
          ...
          for i in $(seq 0 $LIMIT); do
            ...
            kubectl exec -i $INSTANCE -- bash /root/onos/${karafHome}/bin/client log:set WARN org.opencord.sadis
            kubectl exec -i $INSTANCE -- bash /root/onos/${karafHome}/bin/client log:set TRACE org.opencord.aaa
            kubectl exec -i $INSTANCE -- bash /root/onos/${karafHome}/bin/client log:set DEBUG org.opencord.olt
          done
