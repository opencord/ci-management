  ...
  stages {
    ...
    stage('Clone voltha-system-tests') {
      steps {
        ...
        script {
          sh(script:"cd voltha-system-tests; git fetch https://gerrit.opencord.org/voltha-system-tests refs/changes/79/18779/11 && git checkout FETCH_HEAD")
        }
      }
    }
