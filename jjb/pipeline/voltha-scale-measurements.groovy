      ...
      steps {
        sh '''
          if [ ${withMibTemplate} = true ] ; then
            ...
            cat voltha-openonu-adapter/templates/BBSM-12345123451234512345-00000000000001-v1.json | kubectl exec -it -n voltha $(kubectl get pods -n voltha | grep etcd-cluster | awk 'NR==1{print ${expectedOnus}}') etcdctl put service/voltha/omci_mibs/templates/BBSM/12345123451234512345/00000000000001
    ...
    stage('configuration') {
      steps {
        sh '''
          ...
          #kubectl exec -n voltha $(kubectl get pods -n voltha | grep bbsim | awk 'NR==1{print ${expectedOnus}}') bbsimctl log warn false
