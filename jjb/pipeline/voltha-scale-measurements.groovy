  ...
  post {
    ...
    always {
      ...
      sh '''
        ...
        echo $(sshpass -e ssh -q -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -p 30115 karaf@127.0.0.1 flows -s | grep ADDED | wc -l) >> onos-ports-count.txt
      '''
      ...
      sh '''
        rm -rf BBSM-12345123451234512345-00000000000001-v1.json
      '''
