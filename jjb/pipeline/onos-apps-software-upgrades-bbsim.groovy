...
pipeline {
  ...
  stages {
    ...
    stage('ONOS Apps Software Upgrades Tests') {
      environment {
        ROBOT_LOGS_DIR="$WORKSPACE/RobotLogs/ONOSAppsUpgrade"
      }
      steps {
        sh '''
           set +e
           ...
           echo "Download ONOS Apps Version to Upgrade"
           cd $WORKSPACE/voltha-system-tests/tests/data/onos-files
           // TODO: needs update in future for different apps and different versions
           curl -L https://oss.sonatype.org/content/groups/public/org/opencord/aaa-app/2.3.0-SNAPSHOT/aaa-app-2.3.0-20201210.223737-1.oar > org.opencord.aaa.oar
