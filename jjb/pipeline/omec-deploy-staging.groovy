    ...
    stage('Determine Image Tags (Cron Trigger Only)') {
        ...
        steps {
            script {
                ...
                hssdb_tag = """${primaryBranches['c3po']}-${sh script: "git ls-remote https://github.com/omec-project/c3po ${primaryBranches['c3po']} | awk '{print \$1}'", returnStdout: true}"""
                hss_tag = """${primaryBranches['c3po']}-${sh script: "git ls-remote https://github.com/omec-project/c3po ${primaryBranches['c3po']} | awk '{print \$1}'", returnStdout: true}"""
                mme_tag = """${primaryBranches['openmme']}-${sh script: "git ls-remote https://github.com/omec-project/openmme ${primaryBranches['openmme']} | awk '{print \$1}'", returnStdout: true}"""
                mmeExporter_tag = ""
                spgwc_tag = """${primaryBranches['ngic-rtc']}-${sh script: "git ls-remote https://github.com/omec-project/ngic-rtc ${primaryBranches['ngic-rtc']} | awk '{print \$1}'", returnStdout: true}"""
                spgwu_tag = """${primaryBranches['ngic-rtc']}-${sh script: "git ls-remote https://github.com/omec-project/ngic-rtc ${primaryBranches['ngic-rtc']} | awk '{print \$1}'", returnStdout: true}"""
            }
        }
    }
