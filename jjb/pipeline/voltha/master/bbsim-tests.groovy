...
def execute_test(testTarget, workflow, testLogging, teardown, testSpecificHelmFlags = "") {
  ...
  stage('Run test ' + testTarget + ' on ' + workflow + ' workFlow') {
    ...
    ROBOT_MISC_ARGS+="-v ONOS_SSH_PORT:30115 -v ONOS_REST_PORT:30120 -v NAMESPACE:${volthaNamespace} -v INFRA_NAMESPACE:${infraNamespace} -v container_log_dir:$WORKSPACE/${testTarget}-components -v logging:${testLogging}"
