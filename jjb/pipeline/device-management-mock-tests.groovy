    ...
    stage('Deploy Voltha') {
      steps {
        sh '''
           ...
           IMAGES="redfish-mockup-server device-management redfish-importer-demotest"
    ...
    stage('Run E2E Tests') {
      steps {
        sh '''
           ...
           sed -i 's/master/citest/g' kubernetes/deploy-redfish-importer.yaml
           sed -i 's/imagePullPolicy: Always/imagePullPolicy: Never/g' kubernetes/deploy-redfish-importer.yaml
