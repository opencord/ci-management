    ...
    stage('Build') {
      steps {
        sh """
           ...
           if [[ "$GERRIT_PROJECT" =~ ^(cord|rcord|vrouter|vsg|vtn|vtr|fabric|openstack|chameleon|exampleservice|simpleexampleservice|onos-service|olt-service|kubernetes-service)\$ ]]; then
